...
const Profile = () => {
  ...
  const fetchProfile = async () => {
    try {
      const res = await fetch(`https://marathon-event-server.vercel.app/profile/${user.email}`);
  ...
  const fetchStatistics = async () => {
    try {
      const res = await fetch(`https://marathon-event-server.vercel.app/profile/${user.email}/statistics`);
      const data = await res.json();
  ...
  const fetchAchievements = async () => {
    try {
      const res = await fetch(`https://marathon-event-server.vercel.app/profile/${user.email}/achievements`);
      const data = await res.json();
...
//       const res = await fetch('https://marathon-event-server.vercel.app/profile', {
//         headers: {
