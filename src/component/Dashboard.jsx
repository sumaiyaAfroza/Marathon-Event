    ...
    const fetchData = async () => {
      try {
        ...
        const [statsRes, activityRes] = await Promise.all([
          fetch(`https://marathon-event-server.vercel.app/api/dashboard/stats?email=${user.email}`),
          fetch(`https://marathon-event-server.vercel.app/api/dashboard/recent-activity?email=${user.email}`),
        ]);
