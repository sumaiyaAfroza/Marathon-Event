...
const DashboardLayout = () => {
  ...
  return (
    // <div className="min-h-screen flex flex-col bg-gradient-to-b from-blue-200 to-blue-900 ">
...
//         {/* Sidebar or Dropdown */}
//         <aside className="lg:w-72 w-full bg-blue-50 dark:bg-gray-800 border-r border-blue-700">
